...
requests, discussions, and any official communication channels.

## Reporting

To report a Code of Conduct issue, open a private security advisory or a
GitHub Discussion mentioning `@crownkrebs`. Reports will be handled
...
1. **Correction** — a private, written warning, providing clarity around the
   nature of the violation and an explanation of why it was inappropriate.
